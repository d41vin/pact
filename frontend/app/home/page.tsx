...
export default function HomePage() {
  ...
  // 1. Fetch the user's profile from Convex using their connected wallet address.
  ...
  // 2. Handle redirects based on auth and data state.
  useEffect(() => {
  ...
  // 4. If the user exists, render the home page content.
